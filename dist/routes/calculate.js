...
router.post('/calculate', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        result = calculate_shape_1.calculate(req.body);
        id = db.length + 1;
...
router.get('/calculate', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        return [2 /*return*/, res.status(200).json({ data: db })];
    });
}); });
